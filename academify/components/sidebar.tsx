...
const navItems = [
  ...
  { href: "/collaboration", label: "Collab Space", icon: (
    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-1a3 3 0 00-3-3h-1m-4 4H3v-1a3 3 0 013-3h7m-1-8a4 4 0 11-8 0 4 4 0 018 0zm6 8a3 3 0 100-6 3 3 0 000 6zm-5-4h10"/></svg>
  )},
