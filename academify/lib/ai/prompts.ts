...
export function buildRecommendPrompt(
  userProfile: { major?: string | null; bio?: string | null },
  forumNames: string[],
...
Forums joined: ${forumNames.slice(0, 8).join(", ") || "none"}
...
Order by relevance descending. Include only threads genuinely relevant to the user.`;
}
